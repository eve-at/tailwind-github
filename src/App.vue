  ...
  <div class="text-gray-900 text-sm">
    <nav class="bg-gray-900 text-white px-4 py-3 flex items-center justify-between">
      <div class="flex items-center space-x-4">
        <a class="text-white hover:text-gray-400" href="https://github.com/eve-at/tailwind-github" target="_blank">
      ...
      <div class="flex items-center space-x-4 text-white ml-2">
        <a href="#" class="relative hover:text-gray-400">
          ...
          <div class="absolute bg-blue-600 w-2 h-2 rounded-full top-0 right-0"></div>
        </a>
    ...
    <div class="repo-stats flex items-center justify-between px-8 py-4">
      ...
      <div class="flex space-x-2 ml-2">
        <div class="flex text-xs">
          ...
          <a href="#" class="border border-gray-400 rounded rounded-l-none border-l-0 font-semibold px-3 py-1 hover:text-blue-600">
            430
          </a>
        </div>
    ...
    <ul class="repo-nav flex items-center border-b border-gray-400 px-8 mt-4">
      <li>
        <a href="#" 
          class="flex items-center px-4 pb-3 border-b-2"
          :class="{ 
            'border-red-500 font-semibold': true,
            'border-transparent hover:border-gray-400 transition ease-in-out duration-150': false
          }"
        >
          <svg class="w-4 fill-current" classes="UnderlineNav-octicon" display="none inline" viewBox="0 0 16 16" aria-hidden="true">
      ...
      <li>
        <a href="#" 
          class="flex items-center px-4 pb-3 border-b-2"
          :class="{ 
            'border-red-500 font-semibold': false,
            'border-transparent hover:border-gray-400 transition ease-in-out duration-150': true
          }"
        >
          ...
          <div class="bg-gray-200 rounded-lg px-2 text-xs ml-1">107</div>
        </a>
      </li>
      <li>
        <a href="#" 
        ...
        >
          ...
          <div class="bg-gray-200 rounded-lg px-2 text-xs ml-1">17</div>
        </a>
      </li>
      <li>
        <a href="#" 
